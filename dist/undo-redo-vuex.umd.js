(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		exports["undo-redo-vuex"] = factory();
	else
		root["undo-redo-vuex"] = factory();
...
// CONCATENATED MODULE: ./src/undoRedo.ts
...
var UPDATE_CAN_UNDO_REO = "updateCanUndoRedo";
var REDO = "redo";
var UNDO = "undo";

var noop = function noop() {};

var undoRedo_undo = noop;
var undoRedo_redo = noop;
var undoRedo_scaffoldState = function scaffoldState(state) {
  return _objectSpread({}, state, {
    canUndo: false,
    canRedo: false
  });
};
var undoRedo_scaffoldActions = function scaffoldActions(actions) {
  return _objectSpread({}, actions, {
    undo: undoRedo_undo,
    redo: undoRedo_redo
  });
};
var undoRedo_scaffoldMutations = function scaffoldMutations(mutations) {
...
var undoRedo_scaffoldStore = function scaffoldStore(store) {
  return _objectSpread({}, store, {
    state: undoRedo_scaffoldState(store.state || {}),
    actions: undoRedo_scaffoldActions(store.actions || {}),
    mutations: undoRedo_scaffoldMutations(store.mutations || {})
  });
};
/**
...
/* harmony default export */ var undoRedo = (function (options) {
  return function (store) {
    ...
    var paths = options.paths ? options.paths.map(function (_ref2) {
      ...
      return createPathConfig(_objectSpread({
        ...
        }).concat("".concat(namespace, "/").concat(UPDATE_CAN_UNDO_REO))
      } : {}));
    }) : [createPathConfig({
      ignoreMutations: _toConsumableArray(options.ignoreMutations || []).concat([UPDATE_CAN_UNDO_REO])
    })];
    /**
    ...
    var getConfig = function getConfig(namespace) {
      return paths.find(function (path) {
        return path.namespace === namespace;
      }) || {};
    };

    var canRedo = function canRedo(namespace) {
      var config = getConfig(namespace);
    ...
    var canUndo = function canUndo(namespace) {
      var config = getConfig(namespace);
    ...
    var updateCanUndoRedo = function updateCanUndoRedo(namespace) {
      var undoEnabled = canUndo(namespace);
      var redoEnabled = canRedo(namespace);
      store.commit("".concat(namespace).concat(UPDATE_CAN_UNDO_REO), {
        canUndo: undoEnabled
      });
      store.commit("".concat(namespace).concat(UPDATE_CAN_UNDO_REO), {
        canRedo: redoEnabled
    ...
    var pipeActions = function pipeActions(actions) {
      return actions.filter(function (_ref3) {
        var action = _ref3.action;
        return !!action;
      }).reduce(function (promise, _ref4) {
    ...
    var setConfig = function setConfig(namespace, config) {
          ...
          while (1) {
            switch (_context2.prev = _context2.next) {
              case 0:
                 ...
                 */
                _config$undone$reduce = config.undone.reduceRight(function (_ref6, m) {
                  var commits = _ref6.commits,
                      undone = _ref6.undone,
                      proceed = _ref6.proceed;
                  ...
                  if (!commits.length) {
                    ...
                    commits = _toConsumableArray(proceed ? [m] : []).concat(_toConsumableArray(commits));
                    undone = _toConsumableArray(proceed ? [] : [m]).concat(_toConsumableArray(undone));
                  }
              ...
              case 11:
                config.done = _toConsumableArray(config.done).concat(_toConsumableArray(commits));
                config.newMutation = true;
                setConfig(namespace, _objectSpread({}, config, {
                  undone: undone
                }));
          ...
          while (1) {
            switch (_context4.prev = _context4.next) {
              case 0:
                 ...
                 */
                _config$done$reduceRi = config.done.reduceRight(function (_ref10, m) {
                  var commits = _ref10.commits,
                      done = _ref10.done,
                      proceed = _ref10.proceed;
                  ...
                  if (!commits.length) {
                    ...
                    proceed = m.payload.actionGroup && m.payload.actionGroup === actionGroup;
                    commits = _toConsumableArray(proceed ? [m] : []).concat(_toConsumableArray(commits));
                    done = _toConsumableArray(proceed ? [] : [m]).concat(_toConsumableArray(done));
                  }
                ...
                undoCallbacks = commits.map(function (_ref11) {
                ...
                _context4.next = 6;
                return pipeActions(undoCallbacks);

              case 6:
                undone = _toConsumableArray(config.undone).concat(_toConsumableArray(commits));
    ...
    store.subscribe(function (mutation) {
      ...
      if (Object.keys(config).length) {
        ...
        if (mutation.type !== "".concat(namespace).concat(EMPTY_STATE) && mutation.type !== "".concat(namespace).concat(UPDATE_CAN_UNDO_REO) && ignoreMutations.indexOf(mutation.type) === -1 && mutation.type.includes(namespace) && newMutation) {
          done.push(mutation);
          setConfig(namespace, _objectSpread({}, config, {
            done: done
          }));
          ...
          while (1) {
            switch (_context5.prev = _context5.next) {
              case 0:
                ...
                _context5.next = _context5.t0 === "".concat(namespace).concat(REDO) ? 5 : _context5.t0 === "".concat(namespace).concat(UNDO) ? 9 : 13;
                break;

              case 5:
                if (!canRedo(namespace)) {
                  _context5.next = 8;
                  break;
                }

                _context5.next = 8;
                return redo(namespace);

              case 8:
                return _context5.abrupt("break", 14);

              case 9:
                if (!canUndo(namespace)) {
                  _context5.next = 12;
                  break;
                }

                _context5.next = 12;
                return undo(namespace);
...
/* concated harmony reexport undo */__webpack_require__.d(__webpack_exports__, "undo", function() { return undoRedo_undo; });
/* concated harmony reexport redo */__webpack_require__.d(__webpack_exports__, "redo", function() { return undoRedo_redo; });
/* concated harmony reexport scaffoldState */__webpack_require__.d(__webpack_exports__, "scaffoldState", function() { return undoRedo_scaffoldState; });
/* concated harmony reexport scaffoldActions */__webpack_require__.d(__webpack_exports__, "scaffoldActions", function() { return undoRedo_scaffoldActions; });
/* concated harmony reexport scaffoldMutations */__webpack_require__.d(__webpack_exports__, "scaffoldMutations", function() { return undoRedo_scaffoldMutations; });
/* concated harmony reexport scaffoldStore */__webpack_require__.d(__webpack_exports__, "scaffoldStore", function() { return undoRedo_scaffoldStore; });


/* harmony default export */ var entry_lib = __webpack_exports__["default"] = (undoRedo);
...
//# sourceMappingURL=undo-redo-vuex.umd.js.map