...
// CONCATENATED MODULE: ./src/utils-undo-redo.ts
...
var utils_undo_redo_canRedo = function canRedo(paths) {
  return function (namespace) {
...
var utils_undo_redo_canUndo = function canUndo(paths) {
  return function (namespace) {
    var config = getConfig(paths)(namespace);
...
var utils_undo_redo_updateCanUndoRedo = function updateCanUndoRedo(_ref3) {
  var paths = _ref3.paths,
      store = _ref3.store;
  return function (namespace) {
    var undoEnabled = utils_undo_redo_canUndo(paths)(namespace);
    var redoEnabled = utils_undo_redo_canRedo(paths)(namespace);
...
// CONCATENATED MODULE: ./src/redo.ts
          ...
          while (1) {
            switch (_context2.prev = _context2.next) {
              ...
              case 11:
                ...
                utils_undo_redo_updateCanUndoRedo({
                  paths: paths,
                  store: store
                })(namespace);
...
// CONCATENATED MODULE: ./src/undo.ts
...
var undoRedo_mapIgnoreMutations = function mapIgnoreMutations(_ref2) {
...
var undoRedo_mapPaths = function mapPaths(paths) {
  return paths.map(function (_ref3) {
    ...
    }, ignoreMutations ? undoRedo_mapIgnoreMutations({
      namespace: namespace,
      ignoreMutations: ignoreMutations
    }) : {}));
  });
...
var undoRedo_canRedo = function canRedo(paths) {
  return function (namespace) {
    var config = getConfig(paths)(namespace);
...
var undoRedo_canUndo = function canUndo(paths) {
  return function (namespace) {
    var config = getConfig(paths)(namespace);
...
/* harmony default export */ var undoRedo = (function (options) {
  return function (store) {
    var paths = options.paths ? undoRedo_mapPaths(options.paths) : [createPathConfig({
        ...
        return regeneratorRuntime.wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              ...
              case 5:
                if (!undoRedo_canRedo(paths)(namespace)) {
                  _context.next = 8;
                  break;
                }
              ...
              case 9:
                if (!undoRedo_canUndo(paths)(namespace)) {
                  _context.next = 12;
                  break;
                }
