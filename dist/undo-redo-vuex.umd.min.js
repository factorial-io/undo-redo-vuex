(function(g,f){typeof exports==='object'&&typeof module!=='undefined'?f(exports):typeof define==='function'&&define.amd?define(['exports'],f):(g=g||self,f(g.undoRedo={}));}(this,function(exports){'use strict';/**
...
require('./_add-to-unscopables')('includes');// 21.1.3.7 String.prototype.includes(searchString, position = 0)
...
addToUnscopables('entries');// 19.1.2.14 Object.keys(O)
...
});var EMPTY_STATE="emptyState";var UPDATE_CAN_UNDO_REDO="updateCanUndoRedo";var REDO="redo";var UNDO="undo";// 22.1.3.9 Array.prototype.findIndex(predicate, thisArg = undefined)
...
require('./_add-to-unscopables')(KEY);var LIBRARY = require('./_library');
...
$export$3($export$3.S + $export$3.F * (LIBRARY || !USE_NATIVE), PROMISE, {
  // 25.4.4.6 Promise.resolve(x)
  resolve: function resolve(x) {
    return promiseResolve(LIBRARY && this === Wrapper ? $Promise : this, x);
  }
});
$export$3($export$3.S + $export$3.F * !(USE_NATIVE && require('./_iter-detect')(function (iter) {
...
var $find$1 = require('./_array-methods')(5);
var KEY$1 = 'find';
var forced$1 = true;
// Shouldn't skip holes
...
require('./_add-to-unscopables')(KEY$1);/**
 ...
 */var setConfig=function(a){return function(b,c){var d=a.findIndex(function(a){return a.namespace===b});a.splice(d,1,c);}};var canRedo=function(a){return function(b){var c=getConfig(a)(b);return !!Object.keys(c).length&&0<c.undone.length}},canUndo=function(a){return function(b){var c=getConfig(a)(b);return !!c&&0<c.done.length}};var updateCanUndoRedo=function(a){var b=a.paths,c=a.store;return function(a){var d=canUndo(b)(a),e=canRedo(b)(a);c.commit("".concat(a).concat(UPDATE_CAN_UNDO_REDO),{canUndo:d}),c.commit("".concat(a).concat(UPDATE_CAN_UNDO_REDO),{canRedo:e});}};var $at = require('./_string-at')(true);
...
b.subscribe(function(a){var d=1<a.type.split("/").length,e=d?"".concat(a.type.split("/")[0],"/"):"",f=getConfig(c)(e);if(Object.keys(f).length){var g=f.ignoreMutations,h=f.newMutation,i=f.done;a.type!=="".concat(e).concat(EMPTY_STATE)&&a.type!=="".concat(e).concat(UPDATE_CAN_UNDO_REDO)&&-1===g.indexOf(a.type)&&a.type.includes(e)&&h&&(i.push(a),setConfig(c)(e,_objectSpread({},f,{done:i})),updateCanUndoRedo({paths:c,store:b})(e));}}),b.subscribeAction(/*#__PURE__*/function(){var a=_asyncToGenerator(/*#__PURE__*/regeneratorRuntime.mark(function a(d){var e,f;return regeneratorRuntime.wrap(function(a){for(;;)switch(a.prev=a.next){case 0:e=1<d.type.split("/").length,f=e?"".concat(d.type.split("/")[0],"/"):"",a.t0=d.type,a.next=a.t0==="".concat(f).concat(REDO)?5:a.t0==="".concat(f).concat(UNDO)?9:13;break;case 5:if(!canRedo$1(c)(f)){a.next=8;break}return a.next=8,execRedo({paths:c,store:b})(f);case 8:return a.abrupt("break",14);case 9:if(!canUndo$1(c)(f)){a.next=12;break}return a.next=12,execUndo({paths:c,store:b})(f);case 12:return a.abrupt("break",14);case 13:return a.abrupt("break",14);case 14:case"end":return a.stop();}},a)}));return function(){return a.apply(this,arguments)}}());}});exports.default=undoRedo;exports.redo=redo;exports.scaffoldActions=scaffoldActions;exports.scaffoldMutations=scaffoldMutations;exports.scaffoldState=scaffoldState;exports.scaffoldStore=scaffoldStore;exports.undo=undo;Object.defineProperty(exports,'__esModule',{value:true});}));