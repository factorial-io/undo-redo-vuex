...
});var EMPTY_STATE="emptyState";var UPDATE_CAN_UNDO_REDO="updateCanUndoRedo";var REDO="redo";var UNDO="undo";// 7.2.2 IsArray(argument)
 ...
 */var setConfig=function(a){return function(b,c){var d=a.findIndex(function(a){return a.namespace===b});a.splice(d,1,c);}};var canRedo=function(a){return function(b){var c=getConfig(a)(b);return !!Object.keys(c).length&&0<c.undone.length}},canUndo=function(a){return function(b){var c=getConfig(a)(b);return !!c&&0<c.done.length}};var updateCanUndoRedo=function(a){var b=a.paths,c=a.store;return function(a){var d=canUndo(b)(a),e=canRedo(b)(a);c.commit("".concat(a).concat(UPDATE_CAN_UNDO_REDO),{canUndo:d}),c.commit("".concat(a).concat(UPDATE_CAN_UNDO_REDO),{canRedo:e});}};var $at = _stringAt(true);
